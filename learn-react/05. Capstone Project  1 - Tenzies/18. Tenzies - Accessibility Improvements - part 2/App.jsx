...
export default function App() {
    ...
    // 2. Creamos la "etiqueta" para el botón de "New Game".---
    ...
    // 3. SINCRONIZACIÓN: "Cuando gameWon cambie, actúa".-----------------------
    useEffect(() => {
        if (gameWon) {
            buttonRef.current.focus(); // Accedemos al nodo real de forma segura
        }
    }, [gameWon]); // Este efecto solo corre cuando 'gameWon' cambia.-----------
